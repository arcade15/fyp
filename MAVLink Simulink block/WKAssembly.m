...
Output_GetSegmentGlobalTranslation = MyClient.GetSegmentGlobalTranslation('X400', 'X400');
...
% Euler Angles
QuadEulerXYZ = MyClient.GetSegmentGlobalRotationEulerXYZ('X400', 'X400');
ViconPose(4) = QuadEulerXYZ.Rotation(1); % Roll
ViconPose(5) = QuadEulerXYZ.Rotation(2); % Pitch
ViconPose(6) = QuadEulerXYZ.Rotation(3); % Yaw

% *********************************
% Perching Stand (woodbar)
% *********************************
% SubjectName = 'woodbar'; SegmentName = 'woodbar';

% X, Y, Z Global Coordinates of the Quad
Output_GetSegmentGlobalTranslation = MyClient.GetSegmentGlobalTranslation('woodbar', 'woodbar');
...
% Euler Angles
QuadEulerXYZ = MyClient.GetSegmentGlobalRotationEulerXYZ('woodbar', 'woodbar');
...
% *********************************
% Perching Object for Grasping
% *********************************
% SubjectName = 'grasp'; SegmentName = 'grasp';

% X, Y, Z Global Coordinates of the Quad
Output_GetSegmentGlobalTranslation = MyClient.GetSegmentGlobalTranslation('grasp', 'grasp');
...
% Euler Angles
QuadEulerXYZ = MyClient.GetSegmentGlobalRotationEulerXYZ('grasp', 'grasp');
