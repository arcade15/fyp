...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_four_quad_formation_040714_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_X330_Control_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_four_quad_formation_040714_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_X330_Control_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_four_quad_formation_040714_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_X330_Control_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "four_quad_formation_040714") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_four_quad_formation_040714_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "X330_Control") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_X330_Control_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_four_quad_formation_040714_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_X330_Control_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "four_quad_formation_040714") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_four_quad_formation_040714_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "X330_Control") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_X330_Control_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_four_quad_formation_040714_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_X330_Control_method_dispatcher(SimStruct *S, unsigned int
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"four_quad_formation_040714")) {
    return(sf_four_quad_formation_040714_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }

  if (!strcmp(machineName,"X330_Control")) {
    return(sf_X330_Control_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void four_quad_formation_040714_terminator(void);
extern void X330_Control_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    four_quad_formation_040714_terminator();
    X330_Control_terminator();
    sf_debug_terminate();
  }
...
extern void four_quad_formation_040714_initializer(void);
extern void X330_Control_initializer(void);
extern void four_quad_formation_040714_register_exported_symbols(SimStruct* S);
extern void X330_Control_register_exported_symbols(SimStruct* S);
extern void four_quad_formation_040714_debug_initialize(void);
extern void X330_Control_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  four_quad_formation_040714_register_exported_symbols(S);
  X330_Control_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      four_quad_formation_040714_debug_initialize();
    }

    four_quad_formation_040714_initializer();
    if (!simModeIsRTWGen) {
      X330_Control_debug_initialize();
    }

    X330_Control_initializer();
  }
